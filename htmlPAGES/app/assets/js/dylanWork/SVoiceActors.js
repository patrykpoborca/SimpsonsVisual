...
var voiceActorsByCharAmount = [
  ...
  ["Julie Kavner",
    ["Marge Simpson","Selma Bouvier","Patty Bouvier","Jacqueline Bouvier","Gladys Gurney","Alvarine Bisque","Gloria S.","Great Mom","Mabel Simpson","Eve","Margerine of Aragon","Temperance Barrows","Marie"] //chars
  ], //va
  ["Russi Taylor",
    ["Lewis","Wendell Borton","Sherri","Terri","Martin Prince","Martha Prince","Uter Zorker","Maggie Simpson","Ernest Hemingway","Ian (Bart the Genius)","Ronnie Beck"] //chars
  ], //va
  ["Himself",
  ...
  ["Christopher Collins",
    ["Charles Montgomery Burns","Clancy Wiggum","Otto Mann","America's Most Armed and Dangerous Presenter"] //chars
  ], //va
  ["Marcia Mitzman Gaven",
    ["Maude Flanders","Helen Lovejoy","Elizabeth Hoover","Diane (Alone Again, Natura-Diddily)"] //chars
  ], //va
  ["Doris Grau",
  ...
  ["Marcia Wallace",
    ["Edna Krabappel","Ms. Mellon","Mrs. Krabapatra"] //chars
  ], //va
  ["Danny DeVito",
  ...
  ["Steve Allen",
    ["Bart Simpson","Steve Allen (character)"] //chars
  ], //va
  ["Shelby Grimm",
    ["Barney Gumble","Clancy Wiggum"] //chars
  ], //va
  ["Matt Groening",
    ["Matt Groening (character)","Maggie Simpson"] //chars
  ], //va
  ["George Takei",
    ["Akira","Wink"] //chars
  ], //va
  ["Tracey Ullman",
    ["Sylvia Winfield","Emily Winthrop"] //chars
  ], //va
  ["James Earl Jones",
    ["Maggie Simpson","The Raven Narrator"] //chars
  ], //va
  ["Richard Dawkins",
    ["Devil","Richard Dawkins (character)"] //chars
  ], //va
  ["Sam McMurray",
    ["Duff Beer Advertiser","Springfield Nuclear Power Plant Employee"] //chars
  ], //va
  ["Sab Shimono",
    ["Mr. Sparkle","Master Sushi Chef"] //chars
  ], //va
  ["Audrey Meadows",
    ["Beatrice Simmons","Unnamed Carnival Woman"] //chars
  ], //va
  ["Anne Hathaway",
    ["Princess Penelope","Jenny"] //chars
  ], //va
  ["Dave Thomas",
    ["Bob Hope (character)","Rex Banner"] //chars
  ], //va
  ["Alec Baldwin",
    ["Alec Baldwin (character)","Caleb Thorn"] //chars
  ], //va
  ["Lona Williams",
    ["Amber Dempsey","Truong Van Dinh"] //chars
  ], //va
  ["Susan Sarandon",
    ["Ballet Teacher","FeMac"] //chars
  ], //va
  ["Emily Blunt",
    ["Juliet Hobbes","Queen Valedictoria"] //chars
  ], //va
  ["Mark Hamill",
    ["Mark Hamill (character)","Mark Hamill (Character)"] //chars
  ], //va
  ["Kristen Wiig",
  ...
  ["Tom Poston",
    ["Capital City Goofball"] //chars
  ], //va
  ["Kathy Griffin",
    ["Francine Rhenquist"] //chars
  ], //va
  ["Jane Kaczmarek",
  ...
  ["Penny Marshall",
    ["Lucille Botzcowski"] //chars
  ], //va
  ["Eric Idle",
    ["Declan Desmond"] //chars
  ], //va
  ["Stephen Hawking",
    ["Stephen Hawking (character)"] //chars
  ], //va
  ["Sara Gilbert",
    ["Laura Powers"] //chars
  ], //va
  ["Ryan Drummond",
    ["Sonic the Hedgehog"] //chars
  ], //va
  ["Jason Griffith",
    ["Sonic the Hedgehog"] //chars
  ], //va
  ...
  ["Gary Coleman",
    ["Gary Coleman (character)"] //chars
  ], //va
  ["Lady Gaga",
    ["Lady Gaga (character)"] //chars
  ], //va
  ["Weird Al Yankovic",
    ["Weird Al Yankovic (character)"] //chars
  ], //va
  ["David Hyde Pierce",
  ...
  ["Michael Carrington",
    ["Sideshow Raheem"] //chars
  ], //va
  ["Anne Bancroft",
    ["Dr. Zweig"] //chars
  ], //va
  ["Michael Jackson",
    ["Leon Kompowsky"] //chars
  ], //va
  ["Kipp Lennon",
    ["Leon Kompowsky"] //chars
  ], //va
  ...
  ["Richard Lewis",
    ["Golem of Prague"] //chars
  ], //va
  ["George Carlin",
    ["Munchie"] //chars
  ], //va
  ["Willie Nelson",
    ["Willie Nelson (character)"] //chars
  ], //va
  ["Shohreh Aghdashloo",
    ["Mina bin Laden"] //chars
  ], //va
  ["Kathleen Turner",
    ["Stacy Lovell"] //chars
  ], //va
  ["Leonard Nimoy",
    ["Leonard Nimoy (character)"] //chars
  ], //va
  ["Bob Hope",
    ["Bob Hope (character)"] //chars
  ], //va
  ["Elton John",
  ...
  ["Jess Harnell",
    ["Charlton Heston"] //chars
  ], //va
  ["Theodore Roosevelt",
    ["Theodore Roosevelt"] //chars
  ], //va
  ["Dick Tufeld",
    ["Lost in Space"] //chars
  ], //va
  ...
  ["Thomas Pynchon",
    ["Thomas Pynchon (character)"] //chars
  ], //va
  ["Kirk Douglas",
    ["Chester Lampwick"] //chars
  ], //va
  ["Donald Sutherland",
  ...
  ["Ron Howard",
    ["Ron Howard (character)"] //chars
  ], //va
  ["James Taylor",
    ["James Taylor (character)"] //chars
  ], //va
  ["Adam West",
    ["Adam West (character)"] //chars
  ], //va
  ["Tito Puente",
    ["Tito Puente (character)"] //chars
  ], //va
  ["Mike Scioscia",
    ["Mike Scioscia (character)"] //chars
  ], //va
  ["Alex Trebek",
    ["Alex Trebek (character)"] //chars
  ], //va
  ["Martin Landau",
    ["The Great Raymondo"] //chars
  ], //va
  ["Meg Ryan",
    ["Dr. Stacey Swanson"] //chars
  ], //va
  ["Joe Namath",
    ["Joe Namath (Character)"] //chars
  ], //va
  ["Johnny Carson",
    ["Johnny Carson (character)"] //chars
  ], //va
  ["Huell Howser",
    ["Huell Howser (character)"] //chars
  ], //va
  ["Eartha Kitt",
    ["Eartha Kitt (character)"] //chars
  ], //va
  ["Miriam Flynn",
    ["Ms. Barr"] //chars
  ], //va
  ["Ed McMahon",
    ["Ed McMahon (character)"] //chars
  ], //va
  ["Robert Evans",
    ["Robert Evans (character)"] //chars
  ], //va
  ["David Copperfield",
    ["David Copperfield (character)"] //chars
  ], //va
  ["Penn Jillette",
    ["Penn Jillette (character)"] //chars
  ], //va
  ["Teller",
    ["Teller (character)"] //chars
  ], //va
  ["Paul Newman",
    ["Paul Newman (character)"] //chars
  ], //va
  ["Michael Moore",
    ["Michael Moore (character)"] //chars
  ], //va
  ["Justin Bieber",
    ["Justin Bieber (character)"] //chars
  ], //va
  ["Cyndi Lauper",
    ["Cyndi Lauper (character)"] //chars
  ], //va
  ["Mandy Moore",
    ["Tabitha Vixx"] //chars
  ], //va
  ["Kimmy Robertson",
    ["Samantha Stankey"] //chars
  ], //va
  ["Steve Martin",
    ["Ray Patterson"] //chars
  ], //va
  ["Jerry Lewis",
    ["Jonathan Frink Sr."] //chars
  ], //va
  ["Jeff Goldblum",
  ...
  ["John Mahoney",
    ["Robert Terwilliger Sr."] //chars
  ], //va
  ["Jane Leeves",
    ["Edwina"] //chars
  ], //va
  ["Parker Posey",
    ["Becky (It's a Mad, Mad, Mad, Mad Marge)"] //chars
  ], //va
  ["Frankie Muniz",
    ["Thelonius"] //chars
  ], //va
  ["Michael York",
    ["Mason Fairbanks"] //chars
  ], //va
  ["Ray Romano",
    ["Ray Magini"] //chars
  ], //va
  ["Steve Buscemi",
    ["Dwight Diddlehopper"] //chars
  ], //va
  ["Stephen Colbert",
    ["Colby Krause"] //chars
  ], //va
  ...
  ["Robert Englund",
    ["Freddy Krueger"] //chars
  ], //va
  ["Lionel Richie",
    ["Lionel Richie (character)"] //chars
  ], //va
  ["Tom Savini",
  ...
  ["June Foray",
    ["Babysitting Lady"] //chars
  ], //va
  ["Jonah Hill",
    ["Andy Hamilton"] //chars
  ], //va
  ["Jordan Nagai",
    ["Charlie (orphan)"] //chars
  ], //va
  ["Neve Campbell",
    ["Cassandra"] //chars
  ], //va
  ...
  ["Darryl Strawberry",
    ["Darryl Strawberry (character)"] //chars
  ], //va
  ["Linda Ronstadt",
  ...
  ["George Harrison",
    ["George Harrison (character)"] //chars
  ], //va
  ["Angela Bassett",
    ["Michelle Obama"] //chars
  ], //va
  ["Joshua Jackson",
    ["Jesse Grass"] //chars
  ], //va
  ...
  ["Wolfgang Puck",
    ["Wolfgang Puck (character)"] //chars
  ], //va
  ["Denis Leary",
    ["Denis Leary (character)"] //chars
  ], //va
  ["Edward Norton",
    ["Devon Bradley"] //chars
  ], //va
  ["Fantasia Barrino",
    ["Clarissa Wellington"] //chars
  ], //va
  ["Sting",
    ["Sting (character)"] //chars
  ], //va
  ["Ernest Borgnine",
    ["Ernest Borgnine (character)"] //chars
  ], //va
  ["Yael Naim",
    ["Dorit"] //chars
  ], //va
  ["Tony Blair",
    ["Tony Blair (character)"] //chars
  ], //va
  ["R. Lee Ermey",
    ["Colonel Leslie Hapablap"] //chars
  ], //va
  ["Buzz Aldrin",
    ["Buzz Aldrin (character)"] //chars
  ], //va
  ["Robert Goulet",
    ["Robert Goulet (character)"] //chars
  ], //va
  ["Ringo Starr",
    ["Ringo Starr (character)"] //chars
  ], //va
  ["Ian McKellen",
    ["Ian McKellen (character)"] //chars
  ], //va
  ["J.K. Rowling",
    ["J. K. Rowling (character)"] //chars
  ], //va
  ["Mary Lynn Rajskub",
    ["Chloe O'Brian"] //chars
  ], //va
  ["Mel Gibson",
    ["Mel Gibson (character)"] //chars
  ], //va
  ["Tom Wolfe",
    ["Tom Wolfe (character)"] //chars
  ], //va
  ["Rod Steiger",
    ["Captain Tenille"] //chars
  ], //va
  ["Ed Asner",
    ["Lifeways Editor"] //chars
  ], //va
  ["Patrick McGoohan",
    ["Number 6"] //chars
  ], //va
  ["Jack Burns",
    ["Edward Christian"] //chars
  ], //va
  ["Britney Spears",
    ["Britney Spears (character)"] //chars
  ], //va
  ["Dennis Franz",
    ["Dennis Franz (character)"] //chars
  ], //va
  ["Bret McKenzie",
    ["Kurt Hardwick"] //chars
  ], //va
  ["Lea Michele",
    ["Lea Michele (character)"] //chars
  ], //va
  ["Cory Monteith",
    ["Cory Monteith (character)"] //chars
  ], //va
  ["Amber Riley",
    ["Amber Riley (character)"] //chars
  ], //va
  ["Marc Wilmore",
    ["Dr. Wilmore"] //chars
  ], //va
  ["Wade Boggs",
    ["Wade Boggs (character)"] //chars
  ], //va
  ["Ira Glass",
    ["Ira Glass (character)"] //chars
  ], //va
  ["Muhammad Yunus",
    ["Muhammad Yunus (character)"] //chars
  ], //va
  ["Mark Zuckerberg",
    ["Mark Zuckerberg (character)"] //chars
  ], //va
  ["Chris Hansen",
    ["Chris Hansen (character)"] //chars
  ], //va
  ["Never spoke",
    ["Ilsa"] //chars
  ], //va
  ["Jemaine Clement",
    ["Ethan Ballantyne"] //chars
  ], //va
  ["Kim Basinger",
    ["Kim Basinger (character)"] //chars
  ], //va
  ["Jane Lynch",
    ["Roz Davis"] //chars
  ], //va
  ["Bill James",
    ["Bill James (character)"] //chars
  ], //va
  ["Linda McCartney",
    ["Linda McCartney (character)"] //chars
  ], //va
  ["Alyson Hannigan",
    ["Melody Juniper"] //chars
  ], //va
  ["Paul Rudd",
    ["Dr. Zander"] //chars
  ], //va
  ...
  ["Willem Dafoe",
    ["The Commandant"] //chars
  ], //va
  ["Brendan Fraser",
    ["Brad"] //chars
  ], //va
  ["Werner Herzog",
    ["Walter Hotenhoffer"] //chars
  ], //va
  ["George Wendt",
    ["Norm Peterson"] //chars
  ], //va
  ["Lisa Leslie",
    ["Lisa Leslie (character)"] //chars
  ], //va
  ["Frances McDormand",
    ["Melanie Upfoot"] //chars
  ], //va
  ["Ping Marshall",
    ["Viktor"] //chars
  ], //va
  ...
  ["Michael Cera",
    ["Nick (The Daughter Also Rises)"] //chars
  ], //va
  ["Anika Noni Rose",
    ["Rita LaFleur"] //chars
  ], //va
  ["Ludacris",
    ["Ludacris (Character)"] //chars
  ], //va
  ["Patton Oswalt",
    ["T-Rex"] //chars
  ], //va
  ...
  ["Tony Bennett",
    ["Tony Bennett (character)"] //chars
  ], //va
  ["Rashida Jones",
    ["Portia"] //chars
  ], //va
  ["Dr. Demento",
    ["Dr. Demento (character)"] //chars
  ], //va
  ["Isabel Sanford",
    ["Isabel Sanford (character)"] //chars
  ], //va
  ["Tina Fey",
    ["Ms. Cantwell"] //chars
  ], //va
  ["Ronaldo",
    ["Ronaldo (character)"] //chars
  ], //va
  ["Frank Gehry",
    ["Frank Gehry (character)"] //chars
  ], //va
  ["Robert Pinsky",
    ["Robert Pinsky (character)"] //chars
  ], //va
  ["Kim Cattrall",
    ["The Simpson daughter"] //chars
  ], //va
  ["Alan Moore",
    ["Alan Moore (character)"] //chars
  ], //va
  ["Art Spiegelman",
    ["Art Spiegelman (character)"] //chars
  ], //va
  ["Daniel Clowes",
    ["Daniel Clowes (character)"] //chars
  ], //va
  ["Jamie Hyneman",
    ["Jamie Hyneman (character)"] //chars
  ], //va
  ["Adam Savage",
    ["Adam Savage (character)"] //chars
  ], //va
  ["Larry Hagman",
    ["Wallace Brady"] //chars
  ], //va
  ...
  ["Charlie Rose",
    ["Charlie Rose (character)"] //chars
  ], //va
  ["Kid Rock",
    ["Kid Rock (character)"] //chars
  ], //va
  ["Joe C.",
    ["Joe C. (character)"] //chars
  ], //va
  ["Jack McBrayer",
    ["Ewell Freestone"] //chars
  ], //va
  ["Ricky Jay",
    ["Ricky Jay (character)"] //chars
  ], //va
  ["Chuck Liddell",
    ["Chuck Liddell (character)"] //chars
  ], //va
  ["Judith Owen",
    ["Judith Owen (character)"] //chars
  ], //va
  ["Magic Johnson",
    ["Magic Johnson (character)"] //chars
  ], //va
  ["Tom Clancy",
    ["Tom Clancy (character)"] //chars
  ], //va
  ["Mary-Kate and Ashley Olsen",
    ["Mary-Kate and Ashley Olsen (characters)"] //chars
  ], //va
  ["Nichelle Nichols",
    ["Nichelle Nichols (character)"] //chars
  ], //va
  ["Rachel Maddow",
    ["Rachel Maddow (character)"] //chars
  ] //va
];  // end var declaration
